...
use Wqrro\forms\{SimpleForm};
use Wqrro\VasarChunkLoader;
...
class Utils{
	...
	public static function broadcastPacketToViewers(CustomPlayer $inPlayer, DataPacket $packet, ?callable $callable = null, ?array $viewers = null) : void{
	...
	public static function clearEntities(Level $level, bool $proj = false, bool $all = false) : void{
		...
		foreach($entities as $entity){
			if(!$entity instanceof CustomPlayer) $entity->close();
			//if($entity instanceof CustomPlayer) $exec=false;
