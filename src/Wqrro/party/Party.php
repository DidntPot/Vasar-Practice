...
class Party
{
    ...
    public function addMember(Player $player)
    {
        ...
        if ($player instanceof CustomPlayer) $player->setParty($this);
        if ($player instanceof CustomPlayer) $player->setPartyRank(self::MEMBER);
        if ($player instanceof CustomPlayer) $player->sendMessage("§aYou joined the party.");
    }
    ...
    public function removeMember(Player $player)
    {
        ...
        if ($player instanceof CustomPlayer) $player->setParty(null);
        if ($player instanceof CustomPlayer) $player->setPartyRank(null);
        if ($player instanceof CustomPlayer) $player->sendMessage("§aYou left the party.");
    }
    ...
    public function kickMember(Player $player)
    {
        ...
        if ($player instanceof CustomPlayer) $player->setParty(null);
        if ($player instanceof CustomPlayer) $player->setPartyRank(null);
        if ($player instanceof CustomPlayer) $player->sendMessage("§cYou were kicked from the party.");
    ...
    public function disband()
    {
        ...
        if ($leader !== null) {
            ...
            if ($leader instanceof CustomPlayer) $leader->setParty(null);
            if ($leader instanceof CustomPlayer) $leader->setPartyRank(null);
        }
